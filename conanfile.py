...
#    version = "1.0"
    ...
    requires = "Qt/5.5.1@common/stable", "SevenZip/1.0.0@common/stable"
    build_requires = "Qt/5.5.1@common/stable", "SevenZip/1.0.0@common/stable"
...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <ItemDefinitionGroup>
    ...
    def package(self):
        ...
        self.copy("*.lib", dst="lib", src=componentName, keep_path=False)
        self.copy("*.dll", dst="bin", src=componentName, keep_path=False)
        self.copy("*.dylib*", dst="lib", src=componentName, keep_path=False)
        self.copy("*.so", dst="lib", src=componentName, keep_path=False)
        self.copy("*.a", dst="lib", src=componentName, keep_path=False)
    ...
    def package_info(self):
      ...
      if self.options.shared == "False":
        self.cpp_info.defines.append("{0}_STATIC_LIBRARY".format(componentName.upper()))
